...
out1 <- read.csv("filterdata/out1_1024really.csv",header = F)
out2 <- read.csv("filterdata/out2_1024really.csv",header = F)
wt <- read.csv("filterdata/weight_1024really.csv",header = F)
...
write.csv(cbind(data1,data1[,3]*10),"filterdata/particle_plot/out_particle1_really.csv")
...
write.csv(cbind(c(1:100),out[-1]),"filterdata/particle_plot/out1_mean_really.csv")
