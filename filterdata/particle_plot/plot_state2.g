...
set size ratio 1/3
plot 'out_particle1.csv' using 2:3:5:4 with circles notitle fs transparent solid 0.65 lw 2.0 pal
set datafile separator ','
replot 'out1_mean.csv' using 2:3 with lines linetype 1 lw 2.0 linecolor rgb '#ffff00 ' title 'Filter'
set datafile separator ','
